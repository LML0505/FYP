...
def index (request,pIndex=1):
    ...
    return render(request,"web/label/index.html",{"piclist":list2,'plist':plist,'pIndex':pIndex,'maxpages':maxpages,'mywhere':mywhere})
...
def detail(request,lid=' ',pIndex=1):
    ...
    if kw1:
        if kw:
            ...
            #start_date=datetime.strptime(kw1,"%Y-%m-%d")
    ...
    return render(request,"web/label/detail.html",{"label":label,"piclist":list2,'plist':plist,'pdex':pIndex,'maxpages':maxpages,'mywhere':mywhere})
...
def label(request,pid=0):
    ...
    #try:
        ob = Picture.objects.get(id=pid)
        context={'obj':ob}
        return render(request,"web/label/label.html",context)
