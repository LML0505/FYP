...
def index (request,pIndex=1):
    ...
    return render(request,"web/uhistory/history.html",{"piclist":list2,'plist':plist,'pIndex':pIndex,'maxpages':maxpages,'mywhere':mywhere})
...
def label(request,pid=0):
    ...
    #try:
        ob = Picture.objects.get(id=pid)
        context={'obj':ob}
        return render(request,"web/uhistory/label.html",context)
'''
    except Exception as err:
